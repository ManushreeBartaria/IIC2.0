...
import { Shield, Search, Building, Users, CheckCircle, AlertTriangle, Eye, TrendingUp } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white">Digital Police Station</h1>
                <p className="text-blue-100 text-sm">Public Safety Management System</p>
              </div>
            </div>
      ...
      <section className="relative py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-12 max-w-3xl mx-auto">
            Transitioning from paper-based systems to secure, tamper-proof digital platform ensuring transparency, accountability, and efficiency in public safety management.
          </p>
      ...
      <footer className="bg-white/5 backdrop-blur-sm border-t border-white/20 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-blue-100">
            <p className="mb-2">Digital Police Station & Public Safety Management System</p>
